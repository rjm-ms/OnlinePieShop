...
namespace OnlinePieShop.Migrations
{
    ...
    [Migration("20201101085107_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlinePieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("OnlinePieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("OnlinePieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("OnlinePieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlinePieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("OnlinePieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("OnlinePieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlinePieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlinePieShop.Models.Pie", b =>
                {
                    b.HasOne("OnlinePieShop.Models.Category", "Category")
                        .WithMany("Pies")
